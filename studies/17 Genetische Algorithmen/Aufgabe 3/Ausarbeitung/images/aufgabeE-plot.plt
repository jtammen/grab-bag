...
set yrange [ 2000.00 : 2550.00 ] reverse nowriteback
...
GNUTERM = "win"
plot 'aufgabeE-results_recgp.dat' title "recgp" with linespoints, 'aufgabeE-results_recpm.dat' title "recpm" with linespoints, 'aufgabeE-results_reccycle.dat' title "reccycle" with lines
#    EOF
